...
public class HowToBuyFragment extends Fragment {
    View myView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_how_to_buy, container, false);
        setHasOptionsMenu(true);
        HtmlTextView foo = myView.findViewById(R.id.how_to_buy);
        foo.setHtml(getString(R.string.how_to_buy), new HtmlResImageGetter1(foo));
        return myView;
    }
